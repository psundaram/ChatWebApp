...
<body>
	...
	<div class="container chat-signin">
		<form class="form-signin" action="signup" method="POST">
			<h2 class="form-signin-heading">Chat sign up</h2>
			<label for="name">Name</label> <input type="text"
				class="input-block-level" placeholder="name" id="name" name="name">
			<label for="userName">UserName</label> <input type="text"
				...
				<label for="email-address">EmailAddress</label> <input type="text"
				class="input-block-level" placeholder="EmailAddress" id="email-address" name="emailAddress">
				<br>
